# LegionPreLiquidSaleFactory
[Git Source](https://github.com/Legion-Team/legion-protocol-contracts/blob/bb72c57782fae97ef9d644762c4c3ac28e3a2e85/src/factories/LegionPreLiquidSaleFactory.sol)

**Inherits:**
[ILegionPreLiquidSaleFactory](/src/interfaces/factories/ILegionPreLiquidSaleFactory.sol/interface.ILegionPreLiquidSaleFactory.md), Ownable
...
The address of the LegionPreLiquidSale implementation contract used as a template.
...
Deploys a new LegionPreLiquidSale contract instance.
...
|Name|Type|Description|
|----|----|-----------|
|`preLiquidOpenApplicationSaleInstance`|`address payable`|The address of the newly deployed and initialized LegionPreLiquidSale instance.|
