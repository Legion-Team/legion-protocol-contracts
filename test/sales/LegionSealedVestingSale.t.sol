...
contract LegionSealedVestingSaleTest is Test {
    ...
    function test_invest_successfullyEmitsCapitalInvested() public {
        ...
        // Expect
        vm.expectEmit();
        emit ILegionSealedVestingSale.CapitalInvested(1000 * 1e6, encryptedVestingInvestor1, investor1, 1);
    ...
    function test_invest_successfullyMintsInvestorPosition() public {
        ...
        vm.prank(investor1);
        LegionSealedVestingSale(payable(legionSaleInstance)).tokenURI(1);
        ...
        assertEq(LegionSealedVestingSale(payable(legionSaleInstance)).tokenURI(1), "https://metadata.legion.cc/1");
    }
    ...
    function test_updateSealedVestingOption_successfullyEmitsSealedVestingOptionUpdated() public {
        ...
        // Expect
        vm.expectEmit();
        emit ILegionSealedVestingSale.SealedVestingOptionUpdated(1, investor1, encryptedVestingInvestor2);
    ...
    function test_transferInvestorPosition_successfullyTransfersInvestorPosition() public {
        ...
        vm.prank(investor1);
        ILegionSealedVestingSale(legionSaleInstance).withdrawExcessInvestedCapital(0, signatureInv1ExcessWithdrawal);

        // Act
        vm.prank(legionBouncer);
        LegionSealedVestingSale(payable(legionSaleInstance)).transferInvestorPosition(investor1, investor2, 1);

        // Expect
        vm.expectRevert(abi.encodeWithSelector(Errors.LegionSale__InvestorPositionDoesNotExist.selector));
        LegionSealedVestingSale(payable(legionSaleInstance)).investorPosition(investor1);
        assertEq(
            LegionSealedVestingSale(payable(legionSaleInstance)).investorPosition(investor2).investedCapital, 1000 * 1e6
        );
    ...
    function test_transferInvestorPosition_successfullyTransfersInvestorPositionToExistingInvestor() public {
        ...
        assertEq(
            LegionSealedVestingSale(payable(legionSaleInstance)).investorPosition(investor2).investedCapital, 2000 * 1e6
        );
    }
    ...
    function test_transferInvestorPosition_revertsIfNotCalledByLegion() public {
        ...
        vm.prank(investor1);
        ILegionSealedVestingSale(payable(legionSaleInstance)).invest(
            1000 * 1e6, (block.timestamp + 100), sealedVestingDataInvestor1, signatureInv1
        );
    ...
    function test_transferInvestorPositionWithSignature_successfullyTransfersInvestorPosition() public {
        ...
        // Act
        vm.prank(investor1);
        LegionSealedVestingSale(payable(legionSaleInstance)).transferInvestorPositionWithAuthorization(
