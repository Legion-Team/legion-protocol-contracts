...
contract LegionSealedBidAuctionSaleTest is Test {
    ...
    function test_invest_successfullyEmitsCapitalInvested() public {
        ...
        emit ILegionSealedBidAuctionSale.CapitalInvested(
            1000 * 1e6, encryptedAmountInvestort1, uint256(uint160(investor1)), investor1, startTime() + 1, 1
        );
    ...
    function test_transferInvestorPosition_successfullyTransfersInvestorPosition() public {
        ...
        // Expect
        vm.expectRevert(abi.encodeWithSelector(Errors.LegionSale__InvestorPositionDoesNotExist.selector));
        LegionSealedBidAuctionSale(payable(legionSealedBidAuctionInstance)).investorPositionDetails(investor1);
        assertEq(
            LegionSealedBidAuctionSale(payable(legionSealedBidAuctionInstance)).investorPositionDetails(investor2)
                .investedCapital,
            1000 * 1e6
