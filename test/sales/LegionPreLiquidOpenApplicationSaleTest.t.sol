...
contract LegionPreLiquidOpenApplicationSaleTest is Test {
    ...
    function capitalRaised() public view returns (uint256 saleTotalCapitalRaised) {
        ILegionAbstractSale.LegionSaleStatus memory _saleStatusDetails =
            LegionPreLiquidOpenApplicationSale(payable(legionSaleInstance)).saleStatusDetails();
    ...
    function test_invest_successfullyEmitsCapitalInvested() public {
        ...
        // Expect
        vm.expectEmit();
        emit ILegionPreLiquidOpenApplicationSale.CapitalInvested(1000 * 1e6, investor1, startTime() + 1, 1);
    ...
    function test_invest_revertsIfSaleIsCanceled() public {
        ...
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).cancelSale();
    ...
    function test_endSale_successfullyEmitsSaleEnded() public {
        ...
        // Expect
        vm.expectEmit();
        emit ILegionPreLiquidOpenApplicationSale.SaleEnded(1);
    ...
    function test_publishCapitalRaised_successfullyEmitsCapitalRaisedPublished() public {
        ...
        // Act
        vm.prank(legionBouncer);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).publishCapitalRaised(
    ...
    function test_withdrawRaisedCapital_successfullyEmitsCapitalWithdraw() public {
        ...
        // Expect
        vm.expectEmit();
        emit ILegionAbstractSale.CapitalWithdrawn(capitalRaised(), projectAdmin);
    ...
    function test_withdrawExcessInvestedCapital_successfullyTransfersBackExcessCapital() public {
        ...
        ILegionAbstractSale.InvestorPosition memory _investorPosition =
            LegionPreLiquidOpenApplicationSale(payable(legionSaleInstance)).investorPositionDetails(investor2);
    ...
    function test_transferInvestorPosition_successfullyTransfersInvestorPosition() public {
        ...
        // Expect
        vm.expectRevert(abi.encodeWithSelector(Errors.LegionSale__InvestorPositionDoesNotExist.selector));
        LegionPreLiquidOpenApplicationSale(payable(legionSaleInstance)).investorPositionDetails(investor1);
        assertEq(
            LegionPreLiquidOpenApplicationSale(payable(legionSaleInstance)).investorPositionDetails(investor2)
                .investedCapital,
            1000 * 1e6
