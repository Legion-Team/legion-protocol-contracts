...
contract LegionPreLiquidOpenApplicationSaleTest is Test {
    ...
    function prepareInvestedCapitalFromAllInvestors() public {
        vm.prank(investor1);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).invest(
            1000 * 1e6, (block.timestamp + 100), signatureInv1
        );

        vm.prank(investor2);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).invest(
            2000 * 1e6, (block.timestamp + 100), signatureInv2
        );

        vm.prank(investor3);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).invest(
            3000 * 1e6, (block.timestamp + 100), signatureInv3
        );

        vm.prank(investor4);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).invest(
            4000 * 1e6, (block.timestamp + 100), signatureInv4
        );
    }
    ...
    function test_createPreLiquidSale_successfullyDeployedWithValidParameters() public {
        ...
        ILegionPreLiquidOpenApplicationSale.PreLiquidSaleConfiguration memory _preLiquidSaleConfig =
            LegionPreLiquidOpenApplicationSale(payable(legionSaleInstance)).preLiquidSaleConfiguration();
    ...
    function test_updateLegionOpsFeeInWei_successfullyUpdateLegionOpsFee() public {
        ...
        // Act
        vm.prank(legionBouncer);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).updateLegionOpsFee(34_500_000_000_000);
    }
    ...
    function test_invest_successfullyInvestsWithOpsFee() public {
        ...
        // Act
        vm.prank(investor1);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).invest{ value: 34_500_000_000_000 }(
            1000 * 1e6, (block.timestamp + 100), signatureInv1
        );
    }
    ...
    function test_invest_revertsWithWrongOpsFeeAmount() public {
        ...
        // Act
        vm.prank(investor1);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).invest{ value: 10_000_000_000_000 }(
            1000 * 1e6, (block.timestamp + 100), signatureInv1
        );
    }
    ...
    function test_invest_revertsIfAmountLessThanMinimum() public {
        ...
        // Act
        vm.prank(investor1);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).invest(1 * 1e5, (block.timestamp + 100), signatureInv1);
    }
    ...
    function test_invest_revertsIfInvalidSignature() public {
        ...
        vm.prank(investor1);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).invest(
            1000 * 1e6, (block.timestamp + 100), invalidSignature
        );
    }
    ...
    function test_invest_revertsIfSignatureDeadlineHasExpired() public {
        ...
        // Act
        vm.prank(investor1);
        ILegionPreLiquidOpenApplicationSale(legionSaleInstance).invest(1000 * 1e6, 101, signatureInv1);
    }
    ...
    function test_transferInvestorPosition_successfullyTransfersInvestorPosition() public {
        ...
        // Act
        vm.prank(legionBouncer);
        LegionPreLiquidOpenApplicationSale(payable(legionSaleInstance)).transferInvestorPosition(
    ...
    function test_transferInvestorPositionWithSignature_successfullyTransfersInvestorPosition() public {
        ...
        // Act
        vm.prank(investor1);
        LegionPreLiquidOpenApplicationSale(payable(legionSaleInstance)).transferInvestorPositionWithAuthorization(
