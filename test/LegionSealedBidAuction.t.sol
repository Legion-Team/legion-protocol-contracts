...
contract LegionSealedBidAuctionTest is Test {
    ...
    ILegionSealedBidAuction.SealedBidAuctionPeriodAndFeeConfig public salePeriodAndFeeConfig;
    ILegionSealedBidAuction.SealedBidAuctionAddressConfig public saleAddressConfig;

    LegionSealedBidAuction public sealedBidAuctionTemplate;
    ...
    function setSaleConfig(
        ILegionSealedBidAuction.SealedBidAuctionPeriodAndFeeConfig memory _salePeriodAndFeeConfig,
        ILegionSealedBidAuction.SealedBidAuctionAddressConfig memory _saleAddressConfig
    ) public {
        salePeriodAndFeeConfig = ILegionSealedBidAuction.SealedBidAuctionPeriodAndFeeConfig({
            ...
            publicKey: _salePeriodAndFeeConfig.publicKey
        });

        saleAddressConfig = ILegionSealedBidAuction.SealedBidAuctionAddressConfig({
    ...
    function prepareCreateLegionSealedBidAuction() public {
        ...
        legionSealedBidAuctionInstance =
            legionSaleFactory.createSealedBidAuction(salePeriodAndFeeConfig, saleAddressConfig);
    }
    ...
    function prepareMintAndApproveInvestorTokens() public {
        ...
        vm.prank(investor1);
        MockToken(bidToken).approve(legionSealedBidAuctionInstance, 1000 * 1e18);

        vm.prank(investor2);
        MockToken(bidToken).approve(legionSealedBidAuctionInstance, 2000 * 1e18);

        vm.prank(investor3);
        MockToken(bidToken).approve(legionSealedBidAuctionInstance, 3000 * 1e18);

        vm.prank(investor4);
        MockToken(bidToken).approve(legionSealedBidAuctionInstance, 4000 * 1e18);
    }
    ...
    function preparePledgedCapitalFromAllInvestors() public {
        ...
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).pledgeCapital(
            1000 * 1e18, sealedBidDataInvestor1, signatureInv1
        );

        vm.prank(investor2);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).pledgeCapital(
            2000 * 1e18, sealedBidDataInvestor2, signatureInv2
        );

        vm.prank(investor3);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).pledgeCapital(
            3000 * 1e18, sealedBidDataInvestor3, signatureInv3
        );

        vm.prank(investor4);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).pledgeCapital(
            4000 * 1e18, sealedBidDataInvestor4, signatureInv4
        );
    }
    ...
    function test_createSealedBidAuction_successfullyDeployedWithValidParameters() public {
        ...
        LegionSealedBidAuction.SealedBidAuctionPeriodAndFeeConfig memory periodAndFeeConfig =
    ...
    function test_initialize_revertsIfAlreadyInitialized() public {
        ...
        // Act
        LegionSealedBidAuction(payable(legionSealedBidAuctionInstance)).initialize(
    ...
    function test_initialize_revertInitializeImplementation() public {
        ...
        // Act
        LegionSealedBidAuction(payable(sealedBidAuctionImplementation)).initialize(
            salePeriodAndFeeConfig, saleAddressConfig
        );
    }
    ...
    function test_initialize_revertInitializeTemplate() public {
        ...
        // Act
        LegionSealedBidAuction(sealedBidAuctionTemplate).initialize(salePeriodAndFeeConfig, saleAddressConfig);
    }
    ...
    function test_pledgeCapital_successfullyEmitsCapitalPledged() public {
        ...
        emit ILegionSealedBidAuction.CapitalPledged(
            1000 * 1e18, encryptedAmountInvestort1, uint256(uint160(investor1)), investor1, startTime() + 1
        );
    ...
    function test_pledgeCapital_revertsIfDifferentPublicKey() public {
        ...
        vm.prank(investor1);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).pledgeCapital(
            1000 * 1e18, invalidSealedBidData, signatureInv1
        );
    }
    ...
    function test_pledgeCapital_revertsIfInvalidPublicKey() public {
        ...
        vm.prank(investor1);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).pledgeCapital(
            1000 * 1e18, invalidSealedBidData1, signatureInv1
        );
    }
    ...
    function test_pledgeCapital_revertsIfAmountLessThanMinimum() public {
        ...
        vm.prank(investor1);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).pledgeCapital(
            1 * 1e17, sealedBidDataInvestor1, signatureInv1
        );
    }
    ...
    function test_pledgeCapital_revertsIfInvalidSignature() public {
        ...
        vm.prank(investor1);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).pledgeCapital(
            1000 * 1e18, sealedBidDataInvestor1, invalidSignature
        );
    }
    ...
    function test_emergencyWithdraw_successfullyWithdrawByLegionAdmin() public {
        ...
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).emergencyWithdraw(
            legionAdmin, address(bidToken), 1000 * 1e18
        );
    }
    ...
    function test_cancelSale_revertsIfResultsArePublished() public {
        ...
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).publishSaleResults(
            claimTokensMerkleRoot, 4000 * 1e18, 4000 * 1e18, PRIVATE_KEY
        );
    ...
    function test_publishSaleResults_successfullyEmitsSaleResultsPublished() public {
        ...
        // Assert
        vm.expectEmit();
        emit ILegionSealedBidAuction.SaleResultsPublished(claimTokensMerkleRoot, 4000 * 1e18, 4000 * 1e18, PRIVATE_KEY);
    ...
    function test_publishSaleResults_revertsIfInvalidPrivateKey() public {
        ...
        vm.prank(legionAdmin);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).publishSaleResults(
            claimTokensMerkleRoot, 4000 * 1e18, 4000 * 1e18, PRIVATE_KEY - 1
        );
    }
    ...
    function test_supplyTokens_successfullyEmitsTokensSuppliedForDistribution() public {
        ...
        MockToken(askToken).approve(legionSealedBidAuctionInstance, 4100 * 1e18);
        vm.stopPrank();
    ...
    function test_supplyTokens_revertsIfLegionFeeIsIncorrect() public {
        ...
        MockToken(askToken).approve(legionSealedBidAuctionInstance, 4090 * 1e18);
        vm.stopPrank();
    ...
    function test_supplyTokens_successfullyEmitsIfLegionFeeIsZero() public {
        ...
        MockToken(askToken).approve(legionSealedBidAuctionInstance, 4000 * 1e18);
        vm.stopPrank();
    ...
    function test_supplyTokens_revertsIfNotCalledByProjectAdmin() public {
        ...
        MockToken(askToken).approve(legionSealedBidAuctionInstance, 10250 * 1e18);
        vm.stopPrank();
    ...
    function test_supplyTokens_revertsIfIncorrectAmountSupplied() public {
        ...
        MockToken(askToken).approve(legionSealedBidAuctionInstance, 10240 * 1e18);
        vm.stopPrank();
    ...
    function test_supplyTokens_revertsIfTokensAlreadySupplied() public {
        ...
        MockToken(askToken).approve(legionSealedBidAuctionInstance, 8200 * 1e18);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).supplyTokens(4000 * 1e18, 100 * 1e18);
        vm.stopPrank();
    ...
    function test_cancelExpiredSale_revertsIfTokensSupplied() public {
        ...
        MockToken(askToken).approve(legionSealedBidAuctionInstance, 40100 * 1e18);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).supplyTokens(4000 * 1e18, 100 * 1e18);
        vm.stopPrank();
    ...
    function test_claimExcessCapital_successfullyTransfersBackExcessCapitalTokens() public {
        ...
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).claimExcessCapital(
            1000 * 1e18, excessClaimProofInvestor2
        );
    ...
    function test_claimExcessCapital_revertsIfNoCapitalPledged() public {
        ...
        vm.prank(investor5);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).claimExcessCapital(
            6000 * 1e18, excessClaimProofInvestor5
        );
    }
    ...
    function test_claimTokenAllocation_revertsIfNoCapitalIsPledged() public {
        ...
        vm.prank(legionAdmin);
        ILegionSealedBidAuction(legionSealedBidAuctionInstance).publishSaleResults(
            distributeMerkleRootMalicious, 4000 * 1e18, 4000 * 1e18, PRIVATE_KEY
        );
