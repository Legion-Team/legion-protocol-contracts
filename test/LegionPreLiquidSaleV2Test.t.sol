...
contract LegionPreLiquidSaleV2Test is Test {
    ...
    function test_initialize_revertInitializeImplementation() public {
        // Arrange
        address fixedPriceSaleImplementation = legionSaleFactory.i_preLiquidSaleV2Template();
     ...
     * @dev Ensures an investor who didn’t invest cannot claim excess, expecting a LegionSale__NoCapitalInvested revert.
     */
