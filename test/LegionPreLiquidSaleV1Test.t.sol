...
contract LegionPreLiquidSaleV1Test is Test {
    ...
    ILegionVestingManager.LegionInvestorVestingConfig investorVestingConfigClaim;
    ...
    function prepareInvestorVestingConfig() public {
        investorVestingConfig = ILegionVestingManager.LegionInvestorVestingConfig(
            ILegionVestingManager.VestingType.LEGION_LINEAR, 0, 31_536_000, 3600, 0, 0, 1e17, address(0)
        );

        investorVestingConfigClaim = ILegionVestingManager.LegionInvestorVestingConfig(
    ...
    function test_invest_successfullyEmitsCapitalInvested() public {
        ...
        ILegionPreLiquidSaleV1(legionPreLiquidSaleInstance).invest(
            10_000 * 1e6, 10_000 * 1e6, 5_000_000_000_000_000, investorVestingConfig, signatureInv1
        );
    }
    ...
    function test_invest_revertsIfInvestingMoreThanAllowed() public {
        ...
        vm.prank(investor1);
        ILegionPreLiquidSaleV1(legionPreLiquidSaleInstance).invest(
            11_000 * 1e6, 10_000 * 1e6, 5_000_000_000_000_000, investorVestingConfig, signatureInv1
        );
    }
    ...
    function test_withdrawExcessInvestedCapital_successfullyEmitsExcessCapitalWithdrawn() public {
        ...
        ILegionPreLiquidSaleV1(legionPreLiquidSaleInstance).withdrawExcessInvestedCapital(
            1000 * 1e6, 9000 * 1e6, 4_000_000_000_000_000, investorVestingConfig, signatureInv1WithdrawExcess
        );
    }
    ...
    function test_withdrawExcessInvestedCapital_revertsIfTryToWithdrawMoreThanExcess() public {
        ...
        vm.prank(investor1);
        ILegionPreLiquidSaleV1(legionPreLiquidSaleInstance).withdrawExcessInvestedCapital(
            2000 * 1e6, 9000 * 1e6, 4_000_000_000_000_000, investorVestingConfig, signatureInv1WithdrawExcess
        );
    }
    ...
    function test_withdrawExcessInvestedCapital_revertsIfInvalidSignatureData() public {
        ...
        vm.prank(investor1);
        ILegionPreLiquidSaleV1(legionPreLiquidSaleInstance).withdrawExcessInvestedCapital(
            1000 * 1e6, 9000 * 1e6, 100, investorVestingConfig, signatureInv1WithdrawExcess
        );
    }
     ...
     */
    function test_claimTokenAllocation_successfullyEmitsTokenAllocationClaimed() public {
        // Arrange
        prepareCreateLegionPreLiquidSale();
        prepareMintAndApproveTokens();
        prepareInvestorSignatures();
        ...
        ILegionPreLiquidSaleV1(legionPreLiquidSaleInstance).claimTokenAllocation(
            uint256(10_000 * 1e6), uint256(5_000_000_000_000_000), investorVestingConfigClaim, signatureInv1Claim
        );
        ...
        assertEq(MockToken(askToken).balanceOf(position.investorVestingConfig.vestingAddress), 4500 * 1e18);
    ...
    function test_claimTokenAllocation_revertsIfAllocationAmountIsUpdatedAndExcessCapitalIsNotClaimed() public {
        ...
        vm.prank(investor1);
        ILegionPreLiquidSaleV1(legionPreLiquidSaleInstance).claimTokenAllocation(
            uint256(10_000 * 1e6), uint256(5_000_000_000_000_000), investorVestingConfigClaim, signatureInv1Updated2
        );
        ...
        vm.prank(investor1);
        ILegionPreLiquidSaleV1(legionPreLiquidSaleInstance).claimTokenAllocation(
            5_000_000_000, 2_500_000_000_000_000, investorVestingConfigClaim, signatureInv1Updated2
        );
        ...
        assertEq(position.hasSettled, true);
        assertEq(MockToken(askToken).balanceOf(position.investorVestingConfig.vestingAddress), 2250 * 1e18);
    ...
    function test_claimTokenAllocation_revertsIfNoCapitalInvested() public {
        ...
        vm.prank(investor5);
        ILegionPreLiquidSaleV1(legionPreLiquidSaleInstance).claimTokenAllocation(
            uint256(10_000 * 1e6), uint256(5_000_000_000_000_000), investorVestingConfig, signatureInv1
        );
    }
    ...
    function test_claimTokenAllocation_revertsIfPositionAlreadySettled() public {
        ...
        vm.prank(investor1);
        ILegionPreLiquidSaleV1(legionPreLiquidSaleInstance).claimTokenAllocation(
            uint256(10_000 * 1e6), uint256(5_000_000_000_000_000), investorVestingConfig, signatureInv1Claim
        );
    }
