...
contract LegionCapitalRaiseTest is Test {
    ...
    function refundEndTime() public view returns (uint256) {
        ILegionCapitalRaise.CapitalRaiseStatus memory _capitalRaiseStatus =
            LegionCapitalRaise(payable(legionCapitalRaiseInstance)).raiseStatusDetails();
    ...
    function test_createCapitalRaise_successfullyCreatedWithCorrectConfiguration() public {
        ...
        ILegionCapitalRaise.CapitalRaiseConfig memory raiseConfig =
            LegionCapitalRaise(payable(legionCapitalRaiseInstance)).raiseConfiguration();
    ...
    function test_pauseRaise_successfullyPauseTheSale() public {
        ...
        // Act
        vm.prank(legionBouncer);
        ILegionCapitalRaise(legionCapitalRaiseInstance).pauseRaise();
    }
    ...
    function test_unpauseRaise_successfullyUnpauseTheSale() public {
        ...
        // Act
        vm.prank(legionBouncer);
        ILegionCapitalRaise(legionCapitalRaiseInstance).unpauseRaise();
    }
    ...
    function test_invest_revertsIfSaleHasEnded() public {
        ...
        vm.prank(projectAdmin);
        ILegionCapitalRaise(legionCapitalRaiseInstance).endRaise();
     ...
     */
    function test_cancelRaise_successfullyEmitsSaleCanceledWithNoCapitalToReturn() public {
        // Arrange
        prepareCreateLegionCapitalRaise();
        prepareMintAndApproveTokens();
        prepareInvestorSignatures();
     ...
     */
    function test_cancelRaise_successfullyEmitsSaleCanceledWithCapitalToReturn() public {
        // Arrange
        prepareCreateLegionCapitalRaise();
        prepareMintAndApproveTokens();
        prepareInvestorSignatures();
     ...
     */
    function test_cancelRaise_revertsIfSaleIsAlreadyCanceled() public {
        // Arrange
        prepareCreateLegionCapitalRaise();
        prepareMintAndApproveTokens();
        prepareInvestorSignatures();
     ...
     */
    function testFuzz_cancelRaise_revertsIfCalledByNonProjectAdmin(address nonProjectAdmin) public {
        // Arrange
     ...
     */
    function test_endRaise_successfullyEndsSale() public {
        // Arrange
        prepareCreateLegionCapitalRaise();
        prepareMintAndApproveTokens();
        ...
        // Expect
        vm.expectEmit();
        emit ILegionCapitalRaise.CapitalRaiseEnded(1);
     ...
     */
    function testFuzz_endRaise_revertsIfCalledByNonProjectOrNonLegionAdmin(address nonProjectOrLegionAdmin) public {
        // Arrange
