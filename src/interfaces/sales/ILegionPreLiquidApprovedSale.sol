...
interface ILegionPreLiquidApprovedSale {
     ...
     */
    event CapitalInvested(uint256 amount, address investor, uint256 tokenAllocationRate, uint256 positionId);
     ...
     * @param positionId ID of the investor's position
     */
    event ExcessCapitalWithdrawn(uint256 amount, address investor, uint256 tokenAllocationRate, uint256 positionId);
     ...
     * @dev Indicates the sale is no longer active and cannot accept investments
     */
    event SaleEnded();
